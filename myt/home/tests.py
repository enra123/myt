...
class TestMytMessageProcess(TestCase):
    ...
    def test_add_myt_to_source(self):
        ...
        process_message_for_db(self.room1.name, message)
    ...
    def test_edit_myt_card(self):
        ...
        process_message_for_db(self.room1.name, message1)
        process_message_for_db(self.room1.name, message2)
        process_message_for_db(self.room1.name, message3)
        process_message_for_db(self.room1.name, message4)
